...
(function () {
    ...
    Music.prototype = {
        ...
        _buildMusicHtml:function (playerUrl) {
            ...
            html += ' messageType="application/x-shockwave-flash" wmode="transparent" play="true" loop="false"';
        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<input messageType="radio" id="radio-' + i + '-' + j + '" name="musicId" class="m-l" onclick="music.doselect(' + (me.pageSize * (i-1) + (j-1)) + ')"/>');
