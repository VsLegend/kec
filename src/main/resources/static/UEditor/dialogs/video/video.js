...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        '<embed class="previewVideo" messageType="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
            ' src="' + conUrl + '"' +
            ' width="' + 420  + '"' +
            ' height="' + 280  + '"' +
            ...
            function addFile(file) {
                ...
                if (file.getStatus() === 'invalid') {
                    ...
                    if ('|png|jpg|jpeg|bmp|gif|'.indexOf('|'+file.ext.toLowerCase()+'|') == -1) {
                        $wrap.empty().addClass('notimage').append('<i class="file-preview file-messageType-' + file.ext.toLowerCase() + '"></i>' +
