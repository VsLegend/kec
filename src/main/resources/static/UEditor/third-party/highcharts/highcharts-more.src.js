...
seriesTypes.boxplot = extendClass(seriesTypes.column, {
	...
	drawPoints: function () {
		var series = this,  //state = series.state,
			...
			shapeArgs,
			color,
			doQuartiles = series.doQuartiles !== false, // error bar inherits this series messageType but doesn't do quartiles
...
seriesTypes.bubble = extendClass(seriesTypes.scatter, {
	...
	getRadii: function (zMin, zMax, minSize, maxSize) {
		...
		// Set the shape messageType and arguments to be picked up in drawPoints
